...
Partial Public Class BDHRDataSet
    ...
    Partial Public Class JobsDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")>  _
        Public Overloads Function AddJobsRow(ByVal job_title As String, ByVal min_salary As Decimal, ByVal max_salary As Decimal, ByVal activo As Boolean) As JobsRow
            Dim rowJobsRow As JobsRow = CType(Me.NewRow,JobsRow)
            Dim columnValuesArray() As Object = New Object() {Nothing, job_title, min_salary, max_salary, activo}
        ...
        Private Sub InitClass()
            ...
            Me.columnmin_salary.AllowDBNull = false
            Me.columnmax_salary.AllowDBNull = false
        End Sub
    ...
    Partial Public Class JobsRow
        ...
        Public Property activo() As Boolean
            Get
                Try 
                    Return CType(Me(Me.tableJobs.activoColumn),Boolean)
                Catch e As Global.System.InvalidCastException
                    Throw New Global.System.Data.StrongTypingException("The value for column 'activo' in table 'Jobs' is DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tableJobs.activoColumn) = value
            End Set
        End Property
        ...
        Public Function IsactivoNull() As Boolean
            Return Me.IsNull(Me.tableJobs.activoColumn)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")>  _
        Public Sub SetactivoNull()
            Me(Me.tableJobs.activoColumn) = Global.System.Convert.DBNull
        End Sub
    End Class
    ...
    Partial Public Class JobsTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Jobs] WHERE (([job_id] = @Original_job_id) AND ([job_title] = "& _ 
                "@Original_job_title) AND ([min_salary] = @Original_min_salary) AND ([max_salary]"& _ 
                " = @Original_max_salary) AND ((@IsNull_activo = 1 AND [activo] IS NULL) OR ([act"& _ 
                "ivo] = @Original_activo)))"
            ...
            Me._adapter.DeleteCommand.Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@Original_min_salary", Global.System.Data.SqlDbType.[Decimal], 0, Global.System.Data.ParameterDirection.Input, 10, 2, "min_salary", Global.System.Data.DataRowVersion.Original, false, Nothing, "", "", ""))
            Me._adapter.DeleteCommand.Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@Original_max_salary", Global.System.Data.SqlDbType.[Decimal], 0, Global.System.Data.ParameterDirection.Input, 10, 2, "max_salary", Global.System.Data.DataRowVersion.Original, false, Nothing, "", "", ""))
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Jobs] ([job_title], [min_salary], [max_salary], [activo]) VALU"& _ 
                "ES (@job_title, @min_salary, @max_salary, @activo);"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT job_id, job_title, m"& _ 
                "in_salary, max_salary, activo FROM Jobs WHERE (job_id = SCOPE_IDENTITY())"
            ...
            Me._adapter.InsertCommand.Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@min_salary", Global.System.Data.SqlDbType.[Decimal], 0, Global.System.Data.ParameterDirection.Input, 10, 2, "min_salary", Global.System.Data.DataRowVersion.Current, false, Nothing, "", "", ""))
            Me._adapter.InsertCommand.Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@max_salary", Global.System.Data.SqlDbType.[Decimal], 0, Global.System.Data.ParameterDirection.Input, 10, 2, "max_salary", Global.System.Data.DataRowVersion.Current, false, Nothing, "", "", ""))
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Jobs] SET [job_title] = @job_title, [min_salary] = @min_salary, [ma"& _ 
                "x_salary] = @max_salary, [activo] = @activo WHERE (([job_id] = @Original_job_id)"& _ 
                " AND ([job_title] = @Original_job_title) AND ([min_salary] = @Original_min_salar"& _ 
                "y) AND ([max_salary] = @Original_max_salary) AND ((@IsNull_activo = 1 AND [activ"& _ 
                "o] IS NULL) OR ([activo] = @Original_activo)));"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT job_id, job_title, min_s"& _ 
                "alary, max_salary, activo FROM Jobs WHERE (job_id = @job_id)"
            ...
            Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@min_salary", Global.System.Data.SqlDbType.[Decimal], 0, Global.System.Data.ParameterDirection.Input, 10, 2, "min_salary", Global.System.Data.DataRowVersion.Current, false, Nothing, "", "", ""))
            Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@max_salary", Global.System.Data.SqlDbType.[Decimal], 0, Global.System.Data.ParameterDirection.Input, 10, 2, "max_salary", Global.System.Data.DataRowVersion.Current, false, Nothing, "", "", ""))
            ...
            Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@Original_min_salary", Global.System.Data.SqlDbType.[Decimal], 0, Global.System.Data.ParameterDirection.Input, 10, 2, "min_salary", Global.System.Data.DataRowVersion.Original, false, Nothing, "", "", ""))
            Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@Original_max_salary", Global.System.Data.SqlDbType.[Decimal], 0, Global.System.Data.ParameterDirection.Input, 10, 2, "max_salary", Global.System.Data.DataRowVersion.Original, false, Nothing, "", "", ""))
        ...
        Private Sub InitConnection()
            ...
            Me._connection.ConnectionString = Global.ReportesEjemplo.My.MySettings.Default.BDHRConnectionString
        End Sub
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT job_id, job_title, min_salary, max_salary, activo FROM dbo.Jobs"
        ...
        Public Overloads Overridable Function Delete(ByVal Original_job_id As Integer, ByVal Original_job_title As String, ByVal Original_min_salary As Decimal, ByVal Original_max_salary As Decimal, ByVal Original_activo As Global.System.Nullable(Of Boolean)) As Integer
            ...
            End If
            Me.Adapter.DeleteCommand.Parameters(2).Value = CType(Original_min_salary,Decimal)
            Me.Adapter.DeleteCommand.Parameters(3).Value = CType(Original_max_salary,Decimal)
        ...
        Public Overloads Overridable Function Insert(ByVal job_title As String, ByVal min_salary As Decimal, ByVal max_salary As Decimal, ByVal activo As Global.System.Nullable(Of Boolean)) As Integer
            ...
            End If
            Me.Adapter.InsertCommand.Parameters(1).Value = CType(min_salary,Decimal)
            Me.Adapter.InsertCommand.Parameters(2).Value = CType(max_salary,Decimal)
        ...
        Public Overloads Overridable Function Update(ByVal job_title As String, ByVal min_salary As Decimal, ByVal max_salary As Decimal, ByVal activo As Global.System.Nullable(Of Boolean), ByVal Original_job_id As Integer, ByVal Original_job_title As String, ByVal Original_min_salary As Decimal, ByVal Original_max_salary As Decimal, ByVal Original_activo As Global.System.Nullable(Of Boolean), ByVal job_id As Integer) As Integer
            If (job_title Is Nothing) Then
                Throw New Global.System.ArgumentNullException("job_title")
            Else
                Me.Adapter.UpdateCommand.Parameters(0).Value = CType(job_title,String)
            End If
            Me.Adapter.UpdateCommand.Parameters(1).Value = CType(min_salary,Decimal)
            Me.Adapter.UpdateCommand.Parameters(2).Value = CType(max_salary,Decimal)
            If (activo.HasValue = true) Then
                Me.Adapter.UpdateCommand.Parameters(3).Value = CType(activo.Value,Boolean)
            Else
                Me.Adapter.UpdateCommand.Parameters(3).Value = Global.System.DBNull.Value
            End If
            Me.Adapter.UpdateCommand.Parameters(4).Value = CType(Original_job_id,Integer)
            If (Original_job_title Is Nothing) Then
                Throw New Global.System.ArgumentNullException("Original_job_title")
            Else
                Me.Adapter.UpdateCommand.Parameters(5).Value = CType(Original_job_title,String)
            End If
            Me.Adapter.UpdateCommand.Parameters(6).Value = CType(Original_min_salary,Decimal)
            Me.Adapter.UpdateCommand.Parameters(7).Value = CType(Original_max_salary,Decimal)
            If (Original_activo.HasValue = true) Then
            ...
            End If
            Me.Adapter.UpdateCommand.Parameters(10).Value = CType(job_id,Integer)
        ...
        Public Overloads Overridable Function Update(ByVal job_title As String, ByVal min_salary As Decimal, ByVal max_salary As Decimal, ByVal activo As Global.System.Nullable(Of Boolean), ByVal Original_job_id As Integer, ByVal Original_job_title As String, ByVal Original_min_salary As Decimal, ByVal Original_max_salary As Decimal, ByVal Original_activo As Global.System.Nullable(Of Boolean)) As Integer
            Return Me.Update(job_title, min_salary, max_salary, activo, Original_job_id, Original_job_title, Original_min_salary, Original_max_salary, Original_activo, Original_job_id)
        End Function
    End Class
